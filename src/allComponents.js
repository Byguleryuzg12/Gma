...
const GMA_TRANSLATION_FIXES = {
  ...
  ru: {
    register:"REGISTRATSIYA", logout:"VYYTI", loginTitle:"Voydite v akkaunt", registerTitle:"Sozdayte besplatnyy akkaunt", viewMarkets:"SMOTRET RYNKI", loginRegister:"VHOD / REGISTRATSIYA", googleContinue:"Prodolzhit s Google", heroBtn1:"SMOTRET RYNKI", heroBtn2:"SMOTRET TARIFY", heroBtn3:"REGISTRATSIYA", heroSubtitle:"Snizhayte neopredelennost s pomoshchyu strukturirovannogo analiza i bolee yasnoy ramki resheniy", step1t:"Registratsiya", step1d:"Sozdayte akkaunt za 30 sekund cherez email ili Google", step2t:"Vyberite plan", step2d:"Vyberite plan ot $2.99 v den", step3t:"Analiziruyte", step3d:"Strategicheskaya yasnost cherez GMA Consensus Engine", step4t:"Prinimayte reshenie", step4d:"Stroyte sobstvennuyu ramku resheniy na nadezhnyh dannyh", howTitle:"Kak eto rabotaet", howSub:"Globalnye investitsii za 4 shaga", featTitle:"Vozmozhnosti platformy", featSub:"Vse v odnom meste", ctaTitle:"Podnimite yasnost resheniy do institutsionalnogo urovnya", ctaSub:"Analiziruyte globalnye rynki professionalno s planami ot $2.99 v den.", ctaBtn1:"Vybrat plan →", ctaBtn2:"Snachala izuchit", ctaFree:"Nachat besplatno", ctaFreeSub:"Izuchayte rynki bez vhoda.", sector:"Sektor", sectors:"SEKTOR", allSectors:"VSE", gainers:"ROST", losers:"PADENIE", live:"ZHIVO", autoRefresh:"AVTOOBNOVLENIE", loadMore:"POKAZAT ESHE", allShown:"VSE ORGANIZATSII POKAZANY", clear:"Ochistit", accountMgmt:"Upravlenie akkauntom", profileInfo:"DANNYE PROFILYA", accountOps:"DEYSTVIYA AKKAUNTA", apiKeyLabel:"KLYUCH DOSTUPA GMA", backToMarkets:"Nazad k rynkam", editProfile:"IZMENIT", saveProfile:"SOHRANIT PROFIL", cancel:"OTMENA", myPlan:"Moy aktivnyy plan", credits:"Kredity", upgrade:"Uvelichit plan", contactTitle:"Svyazhites s nami", footerDesc:"Finansovaya analiticheskaya platforma dlya yasnosti na globalnyh rynkah.", copyright:"Vse prava zashchishcheny.", password:"PAROL", fullname:"POLNOE IMYA", city:"GOROD", phone:"TELEFON", bio:"BIO", socialMedia:"SOTSIALNYE SETI", send:"OTPRAVIT", processing:"OBRABOTKA...", or:"ILI PO EMAIL", pricingTitle:"AI-sila dlya globalnyh investitsiy", selectPlan:"Vybrat plan →", freePlan:"Nachat besplatno", termsNav:"USLOVIYA", refundNav:"VOZVRAT",
    aiAnalysisDemo:"DEMO AI-ANALIZA", negativeFactors:"OTRITSATELNYE FAKTORY", demoContentOnly:"Tolko demo-kontent. Zhivoy vyvod modeli dlya otsenki kompanii budet podklyuchen pozdnee.", companyDemoContentOnly:"tolko demo-kontent. Zhivoy vyvod modeli dlya otsenki kompanii budet podklyuchen pozdnee.", riskAnalysisLoading:"Analiz riska zagruzhaetsya...", aiFeatureLoginRequired:"Dlya funktsiy AI-analiza nuzhno snachala voyti v akkaunt.", error:"Oshibka", noAiKey:"Nuzhna konfiguratsiya klyucha GMA AI. Obratites v podderzhku.", noCredits:"Kredity analiza ischerpany. Vyberite plan, chtoby prodolzhit.", riskAnalysisIntro:"GMA Intelligence Layer analiziruet polozhitelnye i otritsatelnye faktory", demoRisk1:"Kontsentratsiya vyruchki i makrochuvstvitelnost mogut povysit volatilenost snizheniya.", demoRisk2:"Regulyatornoe, marzhinalnoe ili ispolnitelnoe davlenie mozhet oslabit blizhayshiy fon.", demoRisk3:"Riski otsenki rastut, kogda tsenovoy impuls operezhayet fundament.", demoOpp1:"Silnaya rynochnaya pozitsiya mozhet podderzhat tsenovuyu silu i denezhnyy potok.", demoOpp2:"AI, avtomatizatsiya ili rasshirenie produkta mogut sozdat novye kanaly rosta.", demoOpp3:"Operatsionnyy masshtab mozhet prevratit vosstanovlenie sprosa v uluchshenie marzhi.",
    dnaQ_market_scope:"Oblast analiza?", dnaOpt_market_scope_global:"Globalnye rynki", dnaOpt_market_scope_emerging:"Razvivayushchiesya rynki", dnaDetail_market_scope_global:"NASDAQ, NYSE, Evropa, Aziya", dnaDetail_market_scope_emerging:"BIST i podobnye rynki", dnaQ_country:"Fokus-strana / region?", dnaOpt_country_na:"Severnaya Amerika", dnaOpt_country_eu:"Evropa", dnaOpt_country_apac:"Aziya i Tihookeanskiy region", dnaOpt_country_me:"Blizhniy Vostok", dnaQ_sectors:"Prioritetnye ekosistemy (maks. 3)"
  },
  ar: {
...
const GMA_DNA_TRANSLATION_FIXES = {
  ...
  ru: {
    bio:"O sebe", ipoRadarStatus:"IPO RADAR", liveAutoLabel:"ZHIVO", risk:"RISK",
    dnaOpt_sectors_tech:"Tehnologii", dnaOpt_sectors_energy:"Energetika", dnaOpt_sectors_defense:"Oborona", dnaOpt_sectors_food:"Pitanie", dnaOpt_sectors_health:"Zdravoohranenie", dnaOpt_sectors_finance:"Finansy", dnaQ_risk:"Vash stil investirovaniya?", dnaOpt_risk_cube:"Kub", dnaOpt_risk_prism:"Prizma", dnaOpt_risk_pyramid:"Piramida", dnaDetail_risk_cube:"Konservativnyy", dnaDetail_risk_prism:"Sbalansirovannyy", dnaDetail_risk_pyramid:"Agressivnyy", dnaQ_timeframe:"Vash investitsionnyy gorizont?", dnaOpt_timeframe_short:"Korotkiy", dnaOpt_timeframe_medium:"Sredniy", dnaOpt_timeframe_long:"Dolgi", dnaDetail_timeframe_short:"0-1 god", dnaDetail_timeframe_medium:"1-3 goda", dnaDetail_timeframe_long:"3+ let", dnaQ_tone:"Stil analiza?", dnaOpt_tone_clear:"Yasnyy", dnaOpt_tone_technical:"Tehnicheskiy", dnaDetail_tone_clear:"Prosto i kratko", dnaDetail_tone_technical:"Gluboko i po dannym", dnaQ_budget:"Vash masshtab obema?", dnaOpt_budget_micro:"Mikro", dnaOpt_budget_macro:"Makro", dnaOpt_budget_corporate:"Korporativnyy"
  },
  ar: {
...
const GMA_MARKET_ACTION_FIXES = {
  ru: { noApiKey:"Klyuch API ne zadan — dobavte v nastroykah", liveDataUpdated:"Zhivye dannye obnovleny", simulationRunning:"Simulyatsiya rabotaet", cartRemoved:"udaleno iz korziny", basketAdded:"dobavleno v korzinu", watchRemoved:"udaleno iz spiska nablyudeniya", watchAdded:"dobavleno v spisok nablyudeniya", alertCreated:"uvedomlenie sozdano", maxCompare:"Mozhno vybrat ne bolee 5 kompaniy", addedToComparison:"dobavleno k sravneniyu", chart:"GRAFIK", add:"DOBAVIT", watch:"NABLYUDAT", alert:"SIGNAL", aiAnalysis:"AI-ANALIZ", riskOpportunity:"RISK I VOZMOZHNOST", historicalChart:"ISTORICHESKIY GRAFIK", priceRiseAlert:"SIGNAL ROSTA TSENY", riseThreshold:"POROG ROSTA", target:"TSEL", setAlert:"USTANOVIT SIGNAL", cart:"KORZINA", watchlist:"SPISOK", cartEmpty:"Korzina pusta", watchlistEmpty:"Spisok nablyudeniya pust", noPurchasesYet:"Pokupok poka net", remove:"udalit", units:"edinitsy", buyIn:"pokupka", currentValue:"Tekushchaya stoimost", cost:"Stoimost", profitLoss:"Pribyl / Ubytok" },
...
const GMA_PRICING_LEGAL_FIXES = {
  ...
  tr: { pricingManagedLine1:"GMA'ya odeme yapin - GMA Triple Consensus'u sizin icin yonetiyoruz.", pricingManagedLine2:"Tek platform, uc AI motoru.", detailedComparison:"DETAYLI KARSILASTIRMA", feature:"OZELLIK", integratedAiPartners:"ENTEGRE AI ORTAKLARI", apiCostsManaged:"GMA tum API maliyetlerini sizin adiniza yonetir. Tek abonelik, uc AI motoru.", pricingLegalWarning:"Bu platform yatirim tavsiyesi vermez. Tum kararlar yatirimcinin sorumlulugundadir.", secureCheckoutViaPaddle:"PADDLE ILE GUVENLI ODEME", secureCheckoutTitle:"Paddle ile Guvenli Odeme", secureCheckoutBody:"Odemeniz yetkili Merchant of Record is ortagimiz Paddle.com tarafindan guvenle islenir. GMA kart bilgilerinizi saklamaz. Asagidaki buton Paddle'in guvenli odeme sayfasini acar.", proceedToCheckout:"Odemeye Devam Et", startFreeCheckout:"Ucretsiz Basla", checkoutSecuredNote:"Paddle.com guvencesiyle - kart verileri GMA sunucularinda saklanmaz.", openingPaddle:"Paddle odeme ekrani aciliyor...", pleaseWait:"Lutfen bekleyin, bu sayfayi kapatmayin.", planActivatedShort:"plan erisimi etkinlestirildi.", creditsAdded:"kredi hesabiniza eklendi.", plan:"Plan", myProfile:"Profilim" },
  ru: { pricingManagedLine1:"Oplatite GMA - my upravlyaem GMA Triple Consensus za vas.", pricingManagedLine2:"Odna platforma, tri AI-dvizhka.", detailedComparison:"PODROBNOE SRAVNENIE", feature:"FUNKTSIYA", integratedAiPartners:"INTEGRIROVANNYE AI-PARTNERY", apiCostsManaged:"GMA upravlyaet vsemi API-rashodami za vas. Odna podpiska, tri AI-dvizhka.", pricingLegalWarning:"Platforma ne predostavlyaet investitsionnyh rekomendatsiy. Vse resheniya ostayutsya otvetstvennostyu investora.", secureCheckoutViaPaddle:"BEZOPASNAYA OPLATA CHEREZ PADDLE", secureCheckoutTitle:"Bezopasnaya oplata cherez Paddle", secureCheckoutBody:"Platezh bezopasno obrabatyvaetsya Paddle.com, nashim Merchant of Record. GMA ne hranit dannye kart. Knopka nizhe otkroet bezopasnuyu stranicu Paddle.", proceedToCheckout:"Pereyti k oplate", startFreeCheckout:"Nachat besplatno", checkoutSecuredNote:"Zashchishcheno Paddle.com — dannye kart ne hranyatsya na serverah GMA.", openingPaddle:"Otkryvaetsya oplata Paddle...", pleaseWait:"Pozhaluysta, podozhdite i ne zakryvayte stranicu.", planActivatedShort:"dostup plana aktivirovan.", creditsAdded:"kreditov dobavleno v akkaunt.", plan:"Plan", myProfile:"Moy profil" },
...
function PricingPage({
  ...
  }, t('integratedAiPartners')), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'center',
      gap: '16px',
...
{name:'Anthropic', layer:'Analytic Layer',  color:'#d97757',
  ...
  }, t('apiCostsManaged')), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '12px',
      fontSize: '10px',
      color: '#94a3b8'
    }
  }, "\u26A0 ", t('pricingLegalWarning'))), payModal && /*#__PURE__*/React.createElement(PaddlePaymentModal, {
    plan: payModal,
    user: user,
...
const GMA_LEGAL_SECTION_TITLES = {
  ...
  ru: {
    privacy: ["1. Kakuyu informatsiyu my sobiraem", "2. Pravovoe osnovanie obrabotki (GDPR)", "3. Obrabotka platezhey cherez Paddle", "4. Cookie i otslezhivanie", "5. Storonnie postavshchiki dannyh", "6. Vashi prava (GDPR)", "7. Hranenie dannyh", "8. Bezopasnost dannyh", "9. Konfidentsialnost detey", "10. Izmeneniya etoy politiki", "11. Kontakt i kontroler dannyh"],
    terms: ["1. Prinyatie usloviy", "2. Opisanie servisa", "3. Ne finansovaya rekomendatsiya", "4. Akkaunty polzovateley", "5. Podpiski i billing cherez Paddle", "6. Otmena", "7. Dopustimoe ispolzovanie", "8. Intellektualnaya sobstvennost", "9. Ogranichenie otvetstvennosti", "10. Otkaz ot garantiy", "11. Primenimoe pravo i izmeneniya", "12. Kontakt"],
    refund: ["1. 7-dnevnaya garantiya vozvrata", "2. Kak zaprosit vozvrat", "3. Otmena podpiski v odin klik", "4. Platezhi za prodlenie", "5. Isklyucheniya", "6. Platezhnyy protsessor (Paddle)", "7. Kontakt"]
  },
  de: {
